...
<script type="text/javascript">
	...
	function keybord(code){
		 if(code==13)
			 login();
	}
</script>
<body onkeydown="keybord(event.keyCode)">
	...
	<div
		...
		<p style="padding: 30px 0px 10px; position: relative;">
			<span class="u_logo"></span> <input class="ipt" type="text"
				placeholder="请输入用户名或邮箱" value="" id="username" name="username" />
		</p>
		<p style="position: relative;">
			<span class="p_logo"></span> <input class="ipt" id="password"
				type="password" placeholder="请输入密码" value="" name="password" />
		</p>
		...
		<div
			...
			<p style="margin: 0px 35px 20px 45px;">
				<span style="float: left;"><a
					...
					href="javascript:login()">登录</a> </span>
			</p>
		</div>
	</div>
</body>
