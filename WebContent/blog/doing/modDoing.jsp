	...
	<form id="addForm" method="post" action="updateDoing.do">
		...
		<table class="form-table"
			...
			<tr>
				...
				<td><img src="download.do?fileId=${doing.fileId}"></td>
			</tr>
			<tr>
				<td align="right" class="alt" nowrap="nowrap"><font color="red">*</font>&nbsp;心情:</td>
				<%-- <td><input type="text" class="form-control input-sm"
					style="width: 400px;" id="content" name="content"
					value="${doing.content}"></td> --%>
				<td><textarea cols="40" rows="5">${doing.content}</textarea></td>	
			</tr>
		</table>
	</form>
</body>
