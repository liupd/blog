...
<html>
	...
	<body>
		...
		<input type="hidden" name="content" id="content" value="">
			<table class="form-table" style="margin:auto; width:100%; height:100%">
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control input-sm" style="width:200px;" id="title" name="title" placeholder="请输入标题...">
                    </td>
                </tr>
                <tr>
                    <td align="right" class="alt" nowrap="nowrap"><font color="red">*</font>&nbsp;关键字:</td>
                    <td>
                        <input type="text" class="form-control input-sm" style="width:200px;" id="keywords" name="keywords" placeholder="请输入关键字...">
                    </td>
                </tr>
                <tr>
                    <td align="right" class="alt" nowrap="nowrap"><font color="red">*</font>&nbsp;展示图:</td>
                    <td>
                    	<input type="text" id="fileId" value="" name="fileId" >
                ...
                <tr>
                    <td align="right" class="alt" nowrap="nowrap"><font color="red">*</font>&nbsp;简介:</td>
                    <td>
                        <input type="text" class="form-control input-sm" style="width:680px;" id="introduce" name="introduce" placeholder="请输入简介...">
                    </td>
                </tr>
                <tr>
		...
		<div class="panel-footer" style="text-align:center">
				<button type="button" class="btn btn-primary btn-sm" onclick="javascript:save();"><span class="glyphicon glyphicon-saved"></span>&nbsp;保存</button>
